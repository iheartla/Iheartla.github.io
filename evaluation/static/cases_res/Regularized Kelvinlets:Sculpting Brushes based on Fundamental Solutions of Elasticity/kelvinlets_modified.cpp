...
struct myExpressionResultType {
    Eigen::VectorXd p_ε_left_parenthesis_r_right_parenthesis;
    myExpressionResultType(const Eigen::VectorXd & p_ε_left_parenthesis_r_right_parenthesis)
    : p_ε_left_parenthesis_r_right_parenthesis(p_ε_left_parenthesis_r_right_parenthesis)
    {}
};
    ...
    const double & ε)
{
    ...
    return myExpressionResultType(p_ε_left_parenthesis_r_right_parenthesis);
}
  ...
  switch (kp.brushType) {
    ...
    case igl::BrushType::PINCH: {
      ...
      kelvinlet = [&r, &F, &r_norm_sq, &kp](const Scalar& epsilon) {
        ...
        return myExpression(F, r, r_epsilon, a, b, epsilon).p_ε_left_parenthesis_r_right_parenthesis;
      };
      break;
    }
  }
