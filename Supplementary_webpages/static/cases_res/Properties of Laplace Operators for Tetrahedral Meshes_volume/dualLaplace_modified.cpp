...
struct myExpressionResultType {
    ...
    double Vol_left_parenthesis_i_comma__j_comma__k_comma__l_right_parenthesis;
    myExpressionResultType(const Eigen::Matrix<double, 3, 3> & E,
               const double & Vol_left_parenthesis_i_comma__j_comma__k_comma__l_right_parenthesis)
    : E(E),
    Vol_left_parenthesis_i_comma__j_comma__k_comma__l_right_parenthesis(Vol_left_parenthesis_i_comma__j_comma__k_comma__l_right_parenthesis)
    {}
};
...
myExpressionResultType myExpression(
    ...
    const Eigen::Matrix<double, 3, 1> & x₃)
{
    Eigen::Matrix<double, 3, 3> E_0;
    E_0 << x₁ - x₀, x₂ - x₀, x₃ - x₀;
    Eigen::Matrix<double, 3, 3> E = E_0;

    double Vol_left_parenthesis_i_comma__j_comma__k_comma__l_right_parenthesis = 1 / double(6) * (E).determinant();

    return myExpressionResultType(E, Vol_left_parenthesis_i_comma__j_comma__k_comma__l_right_parenthesis);
}

double volume(const Eigen::Vector3d& a, const Eigen::Vector3d& b, const Eigen::Vector3d& c, const Eigen::Vector3d& d)
{
    return myExpression(a, b, c, d).Vol_left_parenthesis_i_comma__j_comma__k_comma__l_right_parenthesis;
}
